...
$(document).ready(function() {
	...
	$("#viewprofile").click(function() {
		...
		$("#div1").load("/Etalenthunt/jsp/candidate/viewprofile_candidate.jsp"); // loads in a division
...
$(document).ready(function() {
	...
	$("#updateprofile").click(function() {
		...
		$("#div1").load("/Etalenthunt/jsp/candidate/updateprofile_candidate.jsp"); // loads in a division
...
$(document).ready(function() {
	...
	$("#upload").click(function() {
		$("#div1").load("/Etalenthunt/jsp/upload.jsp");
...
<div style="background-color:black;width:20%;height:800px;float:left">
 ...
 <button type="button" class="btn btn-success"  style="float:left;width:100%" id="upload">Upload</button>
...
<div style="width:80%;height:800px;float:right;background-image:url('/Etalenthunt/images/clapperboard-movie-spotlight-photo-hd-wallpaper.jpg') ;  " id="div1">
<!-- <img src="/Etalenthunt/images/head-hunter-recruiter-conceptual-d-render-image-depth-field-blur-effect-compass-needle-pointing-word-talent-concept-34810623.jpg" style="opacity: .85;width:100%;height:100%;float:left; "> -->
</div>
